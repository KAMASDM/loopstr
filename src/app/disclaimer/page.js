...
export const metadata = {
  title: "Disclaimer – Understanding Our Content & Responsibility | Loopstr",
  description:
    "Review Loopstr’s Disclaimer to learn about the informational nature of our content, the limits of liability, and how users should interpret the material shared on this platform.",
  openGraph: {
    title: "Disclaimer – Understanding Our Content & Responsibility | Loopstr",
    description:
      "Review Loopstr’s Disclaimer to learn about the informational nature of our content, the limits of liability, and how users should interpret the material shared on this platform.",
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  The information provided on loopstr.co (hereinafter referred
                  to as "the Site," "we," "us," or "our") is for general
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      ...
                      or recommendation by loopstr.co.
                    </li>
                  </ul>
                </div>
              </div>
