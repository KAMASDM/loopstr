...
export const metadata = {
  title: "Cookie Policy – How Loopstr Uses Cookies Mindfully",
  description:
    "Understand how Loopstr uses cookies to improve your browsing experience, analyze traffic, and personalize content. Learn about your choices and privacy preferences.",
  openGraph: {
    title: "Cookie Policy – How Loopstr Uses Cookies Mindfully",
    description:
      "Understand how Loopstr uses cookies to improve your browsing experience, analyze traffic, and personalize content. Learn about your choices and privacy preferences.",
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  loopstr.co (hereinafter referred to as "the Site," "we," "us,"
                  or "our") uses cookies and other similar technologies to
