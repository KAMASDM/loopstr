  ...
  useEffect(() => {
    const fetchCategoryBlogs = async () => {
      try {
        ...
        setLoading(true);
        const response = await ajaxCall(
          `/posts-category/?site_domain=loopstr.co&category_slug=${selectedCategory.slug}`,
          { method: "GET" }
        );
        ...
        <div className="relative container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Explore key areas of digital wellness — from reducing screen time
              to reusing effective routines and recycling tech habits for
              lasting balance.
            </p>
                  ...
                  >
                    <div className="relative h-48">
                      ...
                      <div className="absolute top-4 left-4">
                        <span
                          className="px-3 py-1 rounded-full bg-white/90 text-green-600 text-sm font-medium"
