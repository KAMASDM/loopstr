...
const benefits = [
  "Weekly sustainable living tips",
  "Exclusive upcycling guides",
  "Early access to zero-waste techniques",
  "Monthly recycling challenges",
  "Waste reduction analytics insights",
  "DIY hacks for repurposing items",
];
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 transition-all duration-700">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Get weekly tips on reducing waste, creative reuse ideas, and
              responsible recycling practices to make your lifestyle more
              eco-friendly.
            </p>
          </div>
