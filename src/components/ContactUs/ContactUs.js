        ...
        <div className="relative py-16 sm:py-20">
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <p className="inline-block border border-green-600 py-1 px-3 rounded-full bg-gradient-to-br from-green-700 via-green-600 to-green-700 bg-clip-text text-transparent font-medium text-sm mb-4 shadow-sm">
                SUSTAINABILITY CONNECTION
              </p>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Get Personalized Sustainability Guidance
              </h1>
              <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                Our team of sustainability experts is here to help you reduce
                waste, reuse resources creatively, and recycle responsibly for a
                greener future.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-12 gap-8 lg:gap-10 items-start">
              ...
              >
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <input
                              ...
                              id="name"
                              autoComplete="name"
                              className="pl-10 w-full py-3 px-4 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <input
                            ...
                            autoComplete="off"
                            className="pl-10 w-full py-3 px-4 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
                            placeholder="Waste reduction, recycling, upcycling ideas, etc."
                          />
                        )}
                      />
                    </div>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <textarea
                          ...
                          id="message"
                          rows="5"
                          className="w-full py-3 px-4 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
                          placeholder="Tell us about your sustainability challenges..."
                          aria-required="true"
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-6 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center group focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                  >
                    Send Message
                    <Send
              ...
              <aside className="md:col-span-5 space-y-8">
                ...
                >
                  ...
                  >
                    <Leaf className="h-6 w-6 text-gray-600 mr-3" />
                    Contact Information
                  </h3>
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div
                        className="flex-shrink-0 p-3 bg-green-600 rounded-full mr-4"
                        aria-hidden="true"
                      >
                ...
                >
                  ...
                  <ul className="space-y-3">
                    <li>
                      ...
                      >
                        <ArrowRight
                          className="h-4 w-4 mr-2 text-green-500 transform transition-transform group-hover:translate-x-1 group-hover:text-green-500"
                          aria-hidden="true"
                        />
                        <span>Creating a zero-waste home</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        <ArrowRight
                          className="h-4 w-4 mr-2 text-green-500 transform transition-transform group-hover:translate-x-1"
                          aria-hidden="true"
                        />
                        <span>Creative upcycling projects</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        <ArrowRight
                          ...
                          aria-hidden="true"
                        />
                        <span>Proper recycling guidelines</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        <ArrowRight
                          ...
                          aria-hidden="true"
                        />
                        <span>Starting a community sustainability program</span>
                      </a>
                    </li>
                  </ul>
                </section>
