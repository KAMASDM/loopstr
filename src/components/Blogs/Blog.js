...
export default function Blog() {
    ...
    const fetchBlogs = async () => {
      try {
        const response = await ajaxCall(
          "/all-posts/?site_domain=loopstr.co",
          { method: "GET" }
        );
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await ajaxCall(
          "/get-categories/?site=loopstr.co",
          { method: "GET" }
        );
        if (response?.data?.results?.length > 0) {
          setCategories((prev) => [
        ...
        <div className="relative container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Discover focused content designed to help you Reduce digital
              distractions, Reuse mindful habits, and Recycle your energy toward
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              >
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 md:py-5 rounded-full bg-white text-gray-800 placeholder-gray-500 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
              ...
              <div className="flex justify-center gap-4 mt-6">
                <motion.div
                  ...
                  className="flex p-1 rounded-full bg-green-100 border border-green-600"
                >
                  <button
                    ...
                    className={`px-4 py-1 rounded-full text-sm ${
                      viewMode === "grid"
                        ...
                        : "text-green-700 hover:bg-green-200/60"
                ...
                >
                  {categories.map((category, index) => (
                    <button
                      ...
                      className={`w-full px-4 py-2 text-left rounded-full text-sm font-semibold transition-colors duration-300 border border-green-600 ${
            ...
            <div className="hidden md:flex flex-wrap justify-center gap-4">
              {categories.map((category, index) => (
                <button
                  ...
                  className={`inline-flex items-center justify-center px-6 py-2 rounded-full text-sm font-semibold transition-colors duration-300 border border-green-600  ${
                    selectedCategory === category
                      ? "bg-green-600 text-white shadow-lg shadow-green-500/25"
                      : "bg-white text-green-600 hover:bg-green-50"
                  }`}
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 relative h-64 md:h-auto">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="px-3 py-1 rounded-full bg-white/90 text-green-600 text-sm font-medium">
                ...
                <div className="md:w-1/2 p-6 md:p-8 bg-white flex flex-col">
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 hover:text-green-600">
                    {featuredBlog.title}
                  </h2>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {featuredBlog.tags.slice(0, 3).map((tag, index) => (
                      <Link
                        key={index}
                        href={`/tag/${tag.slug}`}
                        className="inline-flex items-center gap-1 px-2 py-1 rounded-full border-2 border-green-100 bg-green-50 text-green-600 text-sm"
                  ...
                  <div className="mt-auto">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-full border-2 border-green-100 flex items-center justify-center bg-green-100 text-green-600 font-semibold">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="inline-flex items-center gap-1 px-4 py-2 bg-green-100 rounded-full text-green-600 text-sm font-medium hover:bg-green-200 transition-colors">
                        Read Article
                        <ChevronRight
        ...
        {loading ? (
                        ...
                        {blog.tags &&
                          blog.tags.slice(0, 3).map((tag, index) => (
                            <Link
                              key={index}
                              href={`/tag/${tag.slug}`}
                              className="inline-flex items-center gap-1 px-2 py-1 rounded-full border-2 border-green-100 bg-green-100 text-green-600 text-sm"
                              aria-label={`View all posts tagged ${tag.name}`}
                              itemProp="keywords"
                            >
                              <Tag className="h-3 w-3" aria-hidden="true" />{" "}
          ...
          >
            <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <Search className="h-8 w-8 text-green-600" aria-hidden="true" />
            </div>
