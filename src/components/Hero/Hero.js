...
const coreBenefits = [
  {
    id: "core-benefit-1",
    icon: <Recycle className="h-5 w-5 text-green-600" aria-hidden="true" />,
    label: "Reduce Waste",
  },
  {
    id: "core-benefit-2",
    icon: <RefreshCw className="h-5 w-5 text-green-600" aria-hidden="true" />,
    label: "Reuse Resources",
  },
  {
    id: "core-benefit-3",
    icon: <Package className="h-5 w-5 text-green-600" aria-hidden="true" />,
    ...
    >
      ...
      <div className="relative container mx-auto px-6 pt-12 pb-12 text-center z-10">
        <div className="text-center mb-12">
          ...
          >
            Embrace the Loopstr Lifestyle
          </h1>
          <p className="text-lg md:text-xl text-gray-700 mb-10 max-w-3xl mx-auto">
            Discover practical ways to reduce waste, reuse resources creatively,
            and recycle responsibly to build a more sustainable future for our
            planet.
          </p>
